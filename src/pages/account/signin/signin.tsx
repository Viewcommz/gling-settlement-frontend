...
import { InputBox, SignFormContainer, SignInForm, SnsSignin } from "./signIn.styles";
...
function Signin() {
    ...
    const { value: userId, hasValue: userIdHasValue, hasError: userIdHasError, valueChangeHandler: userIdChangeHandler, inputBlurHandler: userIdBlurHander, reset: resetUserId } = useInput(isNotEmpty);
        ...
        <SignFormContainer>
            ...
            <SignInForm onSubmit={submitHandler}>
                ...
                <InputBox>
                    ...
                    <Input type="text" id="email" value={userId} placeholder="이메일을 입력해주세요." onBlur={userIdBlurHander} onChange={userIdChangeHandler} />
                </InputBox>
                <InputBox>
                    <label htmlFor="password">비밀번호</label>
                    <Input type="password" id="password" value={userPWD} placeholder="비밀번호를 입력해주세요" onBlur={userPWDBlurHander} onChange={userPWDChangeHandler} />
                </InputBox>
