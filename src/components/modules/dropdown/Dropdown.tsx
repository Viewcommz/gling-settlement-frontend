...
function ProfileMenuItems() {
  ...
  return (
    <>
      <NavLink className="menu-item" to="/mypage">마이페이지</NavLink>
      <NavLink className="menu-item" to="/support">문의하기</NavLink>
      <div className="menu-item" onClick={signout}>로그아웃</div>
    </>
  )
}
